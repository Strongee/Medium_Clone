...
export class AddFavoritesRelationsBetweenArticleAndUser1660119542560 implements MigrationInterface {
    name = 'AddFavoritesRelationsBetweenArticleAndUser1660119542560'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "articles" ALTER COLUMN "id" SET DEFAULT '1'`);
